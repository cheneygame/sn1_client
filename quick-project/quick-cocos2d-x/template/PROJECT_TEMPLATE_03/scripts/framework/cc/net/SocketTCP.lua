...
function SocketTCP:ctor(__host, __port, __retryConnectWhenFailure)
	print("SocketTCP:ctor",__host, __port, __retryConnectWhenFailure)
...
function SocketTCP:connect(__host, __port, __retryConnectWhenFailure)
	print("***SocketTCP:connect",__host, __port, __retryConnectWhenFailure)
...
function SocketTCP:test()
	print("SocketTCP:test()")
end
...
function SocketTCP:_onConnected()
	...
	local __tick = function()
		while true do
			...
			print("******************__partial or __body",__partial , __body)
