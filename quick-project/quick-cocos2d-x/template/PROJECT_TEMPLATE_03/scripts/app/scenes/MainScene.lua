...
local host = "192.168.0.29" --192.168.177.131
local port = 8888
...
function MainScene:ctor()
	...
	print("*************talkbox.talk_create",result)
    ...
    if not self._socket then
        self._socket = cc.net.SocketTCP.new(host, port, false) --10101 8001
...
function MainScene:onStatus(__event)
	...
	print("------talkbox.talk_create",stringbuffer)
